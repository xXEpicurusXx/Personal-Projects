...
ground_image = pygame.image.load("Flappy Bird/assets/ground.png") #this is for the ground
button = pygame.image.load("Flappy Bird/assets/restart.png")
...
class Pipe(pygame.sprite.Sprite):
    def __init__(self, x, y, position):
        ...
        self.rect = self.image.get_rect()
        #positon 1 = top and postion -1 = bottom
        if position == 1:
...
while run:
    ...
    screen.blit(ground_image, (ground_scroll,568))
    ...
    draw_text(str(score), font, white, int(screen_width / 2 - 15), 20)
    ...
    # background scrolling ground image
